...
- [поддержка функции "горячей" замены модулей](power_organization.md#hot-swap), что позволяет монтировать и демонтировать модули, не прерывая работу контроллера.
