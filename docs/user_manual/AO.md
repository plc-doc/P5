# Модуль аналогового вывода PP-P5-AO
...
Модуль аналогового вывода (AO) (арт. PP-P5-AO) является 8-ми канальным модулем расширения и предназначен для выдачи аналоговых сигналов на внешние устройства.  
