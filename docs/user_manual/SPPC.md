# Модуль счета импульсов REMA-P5-SPPC
...
Модуль счета импульсов (SPPC) (арт. REMA-P5-SPPC) является 8-ми канальным модулем расширения и предназначен для счета импульсов частотой до 200 кГц.
</div>
