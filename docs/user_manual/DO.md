# Модуль дискретного вывода PP-P5-DO
...
Модуль дискретных выходов DO (арт. PP-P5-DO) является 16-ти канальным модулем расширения и предназначен для вывода дискретных команд постоянным напряжением 24 В.
