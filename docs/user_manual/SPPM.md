# Модуль ввода питания PP-P5-SPPM
...
Модуль ввода дополнительного питания (SPPM) (арт. PP-P5-SPPM) является модулем расширения и предназначен для обеспечения питания модулей.
...
По умолчанию, без установки перемычки, модуль PP-P5-SPPM подает питание только в левую сторону.
