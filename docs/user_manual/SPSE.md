# Модуль расширения коммутации REMA-P5-SPSE
...
Модуль расширения коммутации (арт. REMA-P5-SPSE) является модулем расширения и предназначен для организации сложных топологий путем разветвления соединений в системе автоматизации.  
