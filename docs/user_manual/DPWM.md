# Модуль дискретного вывода ШИМ PP-P5-DPWM
...
Модуль дискретных выходов ШИМ (арт. PP-P5-DPWM) является 16-ти канальным модулем расширения и предназначен для вывода сигнала с широтно-импульсной модуляцией.
