# Модуль дискретного вывода ШИМ REMA-P5-DPWM
...
Модуль дискретных выходов ШИМ (арт. REMA-P5-DPWM) является 16-ти канальным модулем расширения и предназначен для вывода сигнала с широтно-импульсной модуляцией.
