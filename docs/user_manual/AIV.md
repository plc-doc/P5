# Модуль аналогового ввода напряжения PP-P5-AIV
...
Модуль аналогового ввода напряжения (AIV) (арт. PP-P5-AIV) является 8-ми канальным модулем расширения и предназначен для получения аналоговых сигналов по напряжению от внешних источников напряжения
</div>
