# Модуль аналогового ввода напряжения REMA-P5-AIV
...
Модуль аналогового ввода напряжения (AIV) (арт. REMA-P5-AIV) является 8-ми канальным модулем расширения и предназначен для получения аналоговых сигналов по напряжению от внешних источников напряжения
</div>
