# Модуль аналогового ввода тока PP-P5-AIC
...
Модуль аналогового ввода тока AIC (арт. PP-P5-AIC) является 16-ти канальным модулем расширения и предназначен для приема сигналов по интерфейсу «токовая петля».
</div>
