# Модуль аналогового ввода тока REMA-P5-AIC
...
Модуль аналогового ввода тока AIC (арт. REMA-P5-AIC) является 16-ти канальным модулем расширения и предназначен для приема сигналов по интерфейсу «токовая петля».
</div>
