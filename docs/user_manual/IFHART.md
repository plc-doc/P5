# Модуль интерфейсный CAN PP-P5-IFHART
...
Модуль аналогового ввода IFHART (арт. PP-P5-IFHART) является 4-канальным модулем расширения и предназначен для приема сигналов по интерфейсу HART.
</div>
